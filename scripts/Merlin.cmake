...
if(NOT DEFINED MERLIN_GIT_ADDR)
	set(MERLIN_GIT_ADDR "https://github.com/Merlin-Collaboration/Merlin")
endif()
...
if (WITH_MEMCHECK AND CTEST_MEMORYCHECK_COMMAND AND ${CTEST_BUILD_CONFIGURATION} MATCHES "Debug")
	set( CTEST_MEMORYCHECK_COMMAND_OPTIONS " --tool=memcheck --leak-check=yes --show-reachable=yes --trace-children=yes --suppressions=${CTEST_BINARY_DIRECTORY}/DeveloperTools/CodeTesting/data/python.supp")
	ctest_memcheck()
	ctest_submit(RETRY_COUNT 5 RETRY_DELAY 60)
endif ()
endif ()
